...
@EnableJpaRepositories(
		basePackages = DataModuleConfig.BASE_PACKAGE,
...
public class JpaDataSourceConfig {
	...
	private static final String ENTITY_PROPERTY_PREFIX = DataModuleConfig.PROPERTY_PREFIX + ".entity";

	public static final String ENTITY_BEAN_NAME_PREFIX = DataModuleConfig.BEAN_NAME_PREFIX + "Entity";
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		LocalContainerEntityManagerFactoryBean build =
				builder
						...
						.packages(DataModuleConfig.BASE_PACKAGE)
						.build();
		build
				.getJpaPropertyMap()
